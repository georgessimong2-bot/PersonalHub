...
namespace PersonalHub.Infrastructure.Migrations
{
    ...
    [Migration("20260901113126_AddExchangeRates")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PersonalHub.Domain.Entities.BenchmarkPrice", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("PersonalHub.Domain.Entities.ExchangeRate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("PersonalHub.Domain.Entities.ExchangeRate", b =>
                {
                    b.HasOne("PersonalHub.Domain.Entities.Currency", "FromCurrency")
                        .WithMany()
                        .HasForeignKey("FromCurrencyId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("PersonalHub.Domain.Entities.Currency", "ToCurrency")
                        .WithMany()
